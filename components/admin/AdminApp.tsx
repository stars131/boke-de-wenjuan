...
type AdminTab = "dashboard" | "topics" | "responses" | "stories" | "guests" | "export";
...
export function AdminApp() {
  ...
  const loadData = async () => {
    ...
    try {
      ...
      const [statsResponse, topicsResponse, responsesResponse, storiesResponse, guestsResponse] = await Promise.all([
      ...
      if (
        [statsResponse, topicsResponse, responsesResponse, storiesResponse, guestsResponse].some(
      ...
      const [statsJson, topicsJson, responsesJson, storiesJson, guestsJson] = await Promise.all([
        statsResponse.json(),
        topicsResponse.json(),
  ...
  return (
    <main className="min-h-screen bg-paper">
      ...
      <div className="mx-auto max-w-7xl px-4 py-5 sm:px-6 lg:px-8">
        {message ? (
          <div role="alert" className="mb-4 rounded-md bg-coral/10 px-4 py-3 text-sm text-coral">
            {message}
          </div>
        ) : null}
